    ...
    <header className="sticky top-0 z-40 w-full border-b border-white/[0.06] bg-bg/90 backdrop-blur-xl">
      <div className="mx-auto flex h-14 w-full max-w-7xl items-center gap-3 px-4 sm:px-6 lg:px-8">
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <button type="button" onClick={openSearch} aria-label="Search stocks" className="flex h-8 w-8 items-center justify-center rounded-xl border border-white/[0.1] bg-white/[0.04] text-slate-400 transition hover:text-slate-200 lg:hidden">
            <Search size={15} />
          </button>
