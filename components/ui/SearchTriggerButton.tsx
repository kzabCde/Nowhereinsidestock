...
export function SearchTriggerButton({ placeholder }: SearchTriggerButtonProps) {
  ...
  const { t } = useI18n();
  return (
    <button type="button" onClick={open} aria-label={t("search.title")} className="group flex h-13 w-full items-center gap-3 rounded-2xl border border-white/[0.09] bg-[#0b1221]/85 px-4 text-left shadow-[0_1px_0_rgba(255,255,255,.05)_inset] transition-all duration-200 hover:-translate-y-px hover:border-accent/25 hover:bg-[#0e1729] hover:shadow-card">
